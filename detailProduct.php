    ...
    <div class="container">
        <div class="card my-4 bg-dark">
            <div class="row text-light">
                ...
                <div class="card-body col-12 col-md-6 text-sm-center text-md-left">
                    ...
                    <form action="" method="POST">
                        ...
                        <button class="btn btn-success mx-0"><?= $qty ?></button>
                        <button name="tambahQty" value="<?= $qty ?>" class="btn btn-light">+</button>
                        <button class="btn btn-light ml-2" name="add" value="<?= $idxProduk ?>">Add to Cart</button>
                    </form>
                </div>
            </div>
        </div>
